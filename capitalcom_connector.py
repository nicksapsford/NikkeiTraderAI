"""
NikkeiTrader AI -- capitalcom_connector.py  (Excalibur)
...
log = logging.getLogger("NikkeiTrader.Excalibur")
...
Nikkei_EPIC       = "J225"   # Capital.com epic for the Japan 225 (verified against demo API 2026-07-06)
PRICE_CACHE_S   = 60
MAX_RETRIES     = 3
RETRY_DELAY_S   = 5
...
class CapitalComConnector:
    ...
    def get_price(self, epic: str = Nikkei_EPIC) -> Optional[dict]:
        """
...
if __name__ == "__main__":
    ...
    if connected:
        ...
        price = cap.get_price()
        if price:
            log.info("Nikkei price: bid=%.1f ask=%.1f mid=%.1f", price["bid"], price["ask"], price["mid"])
