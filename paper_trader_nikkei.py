"""
NikkeiTrader AI -- paper_trader_nikkei.py  (Stanley)
Records every Nikkei spread bet trade and tracks running P&L.
Persists state between sessions via logs/nikkei_trades.csv.
"""
...
from strategy_nikkei import NikkeiTrade, TRAILING_STOP_POINTS

log = logging.getLogger("NikkeiTrader.Stanley")

STARTING_CAPITAL_GBP = 1000.0
LOG_DIR      = Path(__file__).parent / "logs"
TRADES_LOG   = LOG_DIR / "nikkei_trades.csv"
SUMMARY_LOG  = LOG_DIR / "nikkei_summary.txt"
...
class PaperTraderNikkei:
    """
    Stanley -- paper trading accountant for Nikkei spread bets.
    ...
    def __init__(self) -> None:
        ...
        self.current_trade: Optional[NikkeiTrade] = None
        self.trade_history: list[NikkeiTrade]    = []
        ...
        self._restore_state()
        log.info("Stanley ready -- Nikkei paper trader")
    ...
    def _log_trade(self, trade: NikkeiTrade) -> None:
    ...
    def _save_summary(self) -> None:
        ...
        lines = [
            "=" * 50,
            "NikkeiTrader AI -- Stanley Paper Trader Summary",
    ...
    def close_trade(self, price: float, reason: str) -> Optional[NikkeiTrade]:
        ...
        try:
            ...
            with open(path, "a", newline="", encoding="utf-8") as f:
                ...
                w.writerow({"timestamp_utc": datetime.now(timezone.utc).isoformat(),
                    "system": "NikkeiTrader", "direction": t.direction, "entry_price": t.entry_price,
    ...
    def print_status(self) -> None:
        log.info("=" * 60)
        log.info("NikkeiTrader AI -- Stanley Paper Trader Status")
        log.info("-" * 60)
...
if __name__ == "__main__":
    ...
    stanley.open_trade("LONG", 8250.0, "MORNING")
