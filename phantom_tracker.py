...
_BASE_FIELDS = [
    ...
    'market',             # e.g. Nikkei, GOLD, BTC, ETH, US500
...
VERDICT_THRESHOLD = 300  # 300 index pts on the 1hr window (Gaius Commission 003: ~median 1h Nikkei move) -- under = noise (NEUTRAL), over = CORRECT/WRONG
...
def record_decision(market, direction_blocked, price_at_decision,
    ...
    Args:
        market:              str  — e.g. 'Nikkei', 'GOLD', 'BTC', 'ETH', 'US500'
